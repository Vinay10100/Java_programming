...
class OperatorsInJava
{
	void UnaryOperator() {
		 ...
		 * value with all bits inverted, which means it makes every 0 to 1 ,and every 1 to 0.
		 */
	...
	void BitwiseandLogicalOperators()
	{
		 ...
		 *  In case of xor: 0|l = 1, 1|0 = 1, 1|1 = 0, 0|0 = 0 
		*/
		System.out.println("\n Bitwise inclusive OR:"+(12|12));// 1100 | 1100 = 1100
		System.out.println("\n Bitwise exclusive OR:"+(12^12));// 1100 ^ 1100 = 0000 
